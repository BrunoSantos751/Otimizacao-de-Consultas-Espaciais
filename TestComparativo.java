...
public class TestComparativo {
    ...
    static final int REPS = 50; // Aumentado para 50 repetições
    static final int[] SIZES = { 10000, 50000, 100000, 250000, 500000, 1000000  }; // Cenários de N
    ...
    static void rodarCenario(String nome, int N, double space, boolean cluster) {
        ...
        RStarTree rstar = new RStarTree(100);
